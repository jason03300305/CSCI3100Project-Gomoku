...
chat_box = pygame.Rect(900 ,210 , 300, 400)
chat_text = ""
...
while running:
    ...
    Player2_text = default_font2.render("Player2: Ocean", True, "white")  # Render the id 
    ...
    Chat_rect = Chat_text.get_rect(center=(1050, 190))  # Get the rectangle for the menu text and center it    
